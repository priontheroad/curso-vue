        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand">
                ...
                <a href="" class="link navbar-brand mr-auto">
                    <img src="./../assets/logo.svg" alt="Logo" class="img d-inline-block align-top" id="logo"> Portal Futebol
                </a>
                ...
                <div class="links mr-2">
                    ...
                    <router-link to="/ranking" class="btn mr-5">Classificação</router-link>
